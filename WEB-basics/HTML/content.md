...
## Оглавление
1. [Изучение HTML](#Изучение-HTML)
1. [Тэги](##Тэги)
1. [Текстовые тэги](##Текстовые-тэги)
...
1. [Картинки](##Картинки)
1. [Таблицы](##Таблицы)
1. [Div и span](##Div-и-span)
1. [Отступы](##Отступы)
1. [Form](##Form)
1. [Label](##Label)
    1. [Атрибуты form](###Атрибуты-form)
1. [Input](##Input)
    1. [Типы input](###Типы-input)
1. [Textarea](##Textarea)
1. [Button](##Button)
1. [Select](##Select)
1. [Семантические тэги HTML5](##Семантические-тэги-HTML5)
1. [Details](##Details)
1. [Mark](##Mark)
1. [Ruby](##Ruby)
1. [Progress](##Progress)
...
1. [Section](##Section)
1. [Классы](##Классы)
1. [Поток и блочная модель](##Поток-и-блочная-модель)
    1. [Модель любого блочного элемента](###Модель-любого-блочного-элемента)
...
Принудительно наследовать свойства от элемента можно при помощи `inherit`
